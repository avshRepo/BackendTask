...
and then i would split the between the service that listen to the exe output and writes to kafka and the service that reads from kafka and exposes http routes for getting the statistics.
